...
class VectorSearchResult(BaseModel):
    law_documents: list[str]
    law_chunks: list[list[str]]
    law_titles: list[str]
    law_laws: list[str]
    law_urls: list[str]


class VectorSearchCaseLawResult(BaseModel):
    cl_documents: list[str]
    cl_chunks: list[list[str]]
    cl_titles: list[str]
    cl_inhoudsindicaties: list[str]
    cl_date_uitspraken: list[date]
    cl_case_numbers: list[str]
    cl_urls: list[str]


class VectorSearchWerkInstructieResult(BaseModel):
    wi_documents: list[str]
    wi_chunks: list[list[str]]
    wi_titles: list[str]
    wi_urls: list[str]
